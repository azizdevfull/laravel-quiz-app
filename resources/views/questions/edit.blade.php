    ...
    <div class="container">
        ...
        <form action="{{ route('quizzes.questions.update', [$quiz->id, $question->id]) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="answer1" id="answer1" class="form-control" value="{{ $question->answer1 }}" required>
            </div>
            <div class="mb-3">
                <label for="answer2" class="form-label">Answer 2</label>
                <input type="text" name="answer2" id="answer2" class="form-control" value="{{ $question->answer2 }}" required>
            </div>
            <div class="mb-3">
                <label for="answer3" class="form-label">Answer 3</label>
                <input type="text" name="answer3" id="answer3" class="form-control" value="{{ $question->answer3 }}" required>
            </div>
            <div class="mb-3">
                <label for="answer4" class="form-label">Answer 4</label>
                <input type="text" name="answer4" id="answer4" class="form-control" value="{{ $question->answer4 }}" required>
            </div>
            <div class="mb-3">
